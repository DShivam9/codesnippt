...
import { SiJavascript, SiTypescript, SiPython, SiRust, SiGo, SiCplusplus, SiSwift, SiKotlin, SiRuby, SiPhp } from "react-icons/si";
...
export default function LandingPage() {
  ...
  return (
    <main ref={containerRef} className="overflow-x-hidden w-full max-w-full bg-[#050505] text-[#FAFAFA] font-sans selection:bg-[#FF9F0A] selection:text-[#000]">
      ...
      <nav className="nav-bar fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-5 border-b-4 border-[#000] bg-[#FAFAFA] text-[#000]">
        <div className="flex items-center gap-3">
          <div className="bg-[#FF9F0A] p-1.5 border-4 border-[#000]">
            <Code2 className="w-6 h-6 text-[#000]" strokeWidth={3} />
          </div>
          <span className="text-3xl font-black tracking-tighter uppercase">SNIPCAST</span>
        </div>
        ...
        <Link href="/studio" className="bg-[#FF9F0A] text-[#000] px-8 py-3 border-4 border-[#000] font-black tracking-widest text-sm uppercase hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[6px_6px_0px_#000] transition-all">
          Launch App
        </Link>
      </nav>
      ...
      {/* MASSIVE FOOTER */}
      <footer className="bg-[#000] text-[#FAFAFA] pt-32 pb-12 flex flex-col border-t-8 border-[#FAFAFA]">
        <div className="scroll-reveal max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-16 mb-32 border-b-8 border-[#FAFAFA] pb-24 px-6 md:px-12">
          <div className="flex-1">
            <h2 className="text-[clamp(4rem,10vw,10rem)] leading-[0.8] font-black tracking-tighter uppercase mb-8">
              DON'T<br/>SETTLE.
            </h2>
            <p className="text-2xl md:text-4xl font-bold uppercase tracking-tight text-[#FF9F0A] max-w-xl">
              Elevate your codebase with the ultimate aesthetic rendering engine.
            </p>
          </div>
          <div className="shrink-0 group">
            <Link href="/studio" className="flex items-center justify-center w-64 h-64 md:w-80 md:h-80 border-8 border-[#FAFAFA] bg-[#FF9F0A] text-[#000] text-3xl font-black uppercase tracking-tighter hover:bg-[#FAFAFA] hover:border-[#FF9F0A] transition-all duration-300 hover:-translate-y-2 hover:-translate-x-2 shadow-[0px_0px_0px_#FF9F0A] group-hover:shadow-[16px_16px_0px_#FF9F0A]">
              START NOW <ArrowRight className="ml-4 w-10 h-10" strokeWidth={4} />
            </Link>
          </div>
        </div>
        
        <div className="w-full flex flex-col items-center overflow-hidden scroll-reveal">
          <div className="w-full max-w-7xl flex flex-col md:flex-row justify-between items-center text-sm md:text-xl font-black uppercase tracking-widest mb-12 text-[#FAFAFA]/70 gap-8 px-6 md:px-12">
            <div className="flex gap-8">
              <Link href="#" className="hover:text-[#FF9F0A] transition-colors">TWITTER</Link>
              <Link href="#" className="hover:text-[#FF9F0A] transition-colors">GITHUB</Link>
              <Link href="#" className="hover:text-[#FF9F0A] transition-colors">DISCORD</Link>
            </div>
            <span>&copy; {new Date().getFullYear()} SNIPCAST INC.</span>
          </div>
          <div className="w-full overflow-hidden flex whitespace-nowrap">
            <div className="footer-marquee flex w-max">
              <h1 className="text-[21vw] leading-[0.75] font-black tracking-tighter uppercase text-[#FAFAFA] pr-16 select-none">
